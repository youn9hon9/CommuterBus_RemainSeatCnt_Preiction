...
| `prod` | **오늘 6시 30분**까지 대기한 뒤 수집을 시작하고, **API 한도 초과 발생 시 10분 뒤** PC를 끕니다.                                                       |
| `run`  | **6시 30분**까지 대기한 뒤 수집. PC는 끄지 않음. **API 한도 초과 시** 프로그램을 끝내지 않고 **다음 날 같은 시각(로컬)까지 대기**한 뒤 같은 프로세스에서 다시 1분 간격 수집을 반복합니다. |
